...
Graph::Graph(int n) : adj(AdjacencyList(2, vector<vector<pair<int, int>>>(n, vector<pair<int, int>>()))),
...
void ContractionHierarchies::contract_node(int v)
{
  ...
  contract_node_importance = (
    added_shortcuts - outgoing_edges.size() - incoming_edges.size()
